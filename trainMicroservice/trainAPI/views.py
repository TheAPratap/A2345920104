...
def get_trains(request):
    ...
    response = requests.get('http://20.244.56.144/train/trains', headers={
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTIzNzA1MTIsImNvbXBhbnlOYW1lIjoiVHJhaW4gQ2VudHJhbCIsImNsaWVudElEIjoiZGU5OGM1NjgtZWNiMS00N2MzLWE4ZDAtM2M1Mjg2YWUyZmRkIiwib3duZXJOYW1lIjoiIiwib3duZXJFbWFpbCI6IiIsInJvbGxObyI6IkEyMzQ1OTIwMTA0In0.ClfESK-RX8V0sNWSPHcPFBgWyiDsqvs6px8kN2vt8Jc'
    })
